  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => {
          ImageService().uploadImage(widget.modelId),
          _reloadPage()
        },
      ),
      appBar: null,
  ...
  Widget _buildImageList(BuildContext context, ModelImageViewModel image) {
    ...
    Future _showDialog(BuildContext context)
    {
      return showDialog(context: context,builder: (BuildContext context){
        return AlertDialog(
          title: Text("Do you want to delete",style: TextStyle(color: kPrimaryColor),),
          content: SingleChildScrollView(
            child: ButtonBar(
              children: [
                ...
                FlatButton(
                  onPressed: () {
                    ImageService().deleteImage(image.fileName, image.id, widget.modelId);
                    _reloadPage();
                  },
